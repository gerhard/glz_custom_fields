...
/***
  ...
  You can have other functions or classes, but these will not be called by glz_custom_fields. This is handy for helper functions.
  TXP plugins work in the same way. If you want, you can regard these scripts as plugins for glz_custom_fields.
  ...
  * $custom_id = 'custom-14'
  Helpful for form ids. This is an artifact, will be removed at some point.
  
 * $custom_value = 'custom field value for this article'
  Used mainly for comparing with the $default_value


  == AVAILABLE FUNCTIONS
  You can use any functions within the TXP scope (this includes plugins).
  ...
  * fInput($type, $name, $value, $class='', $title='', $onClick='', $size='', $tab='', $id='', $disabled = false)
  This is the default TXP function for creating text fields.
  Find it in textpattern/lib/txplib_forms.php
  ...
  * text_area($name, $h, $w, $thing = '', $id = '')
  This is the default TXP function for creating text areas.
  Find it in textpattern/lib/txplib_forms.php
  ...
  right into TXP. Think big with these scripts because the potential is astounding.
